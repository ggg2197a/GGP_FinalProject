...
{
	CreateBuffer(vertices, numVerts, indices, numIndices, device);
...
Mesh::Mesh(char* objFile, ID3D11Device* device)
{
	...
	CreateBuffer(&verts[0], vertCounter, &indices[0], vertCounter, device);
}
...
void Mesh::CreateBuffer(Vertex* vertices, int numVerts, unsigned int* indices, int numIndices, ID3D11Device* device)
{
...
// Code adapted from: http://www.terathon.com/code/tangent.html - from the demo
